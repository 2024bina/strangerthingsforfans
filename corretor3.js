function corrigir(){
    ...
    if(document.quest1.q2[0].checked){
        pontos = pontos + 1;
    }
    if(document.quest1.q3[3].checked){
        pontos = pontos + 1;
    }
    if(document.quest1.q4[2].checked){
        pontos = pontos + 1;
    }
    if(document.quest1.q5[1].checked){
        pontos = pontos + 1;
    }  
    if(document.quest1.q6[3].checked){
        pontos = pontos + 1;
    }  
    ...
    if(document.quest1.q10[1].checked){
        pontos = pontos + 1;
    } 
